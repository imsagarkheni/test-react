  ...
  return (
    <div>
      <div className="flex justify-between pl-2 pr-2">
        ...
        <Link to={'/products'}>
        <i className="fa-solid fa-arrow-left fa-2xl leading-[48px"></i>
        </Link>
      </div>
      <div class="container mx-auto mt-10">
        <div class="flex shadow-md my-10">
          ...
          <div id="summary" class="w-1/4 px-8 py-10 bg-slate-400">
            ...
            <div class="py-10">
              ...
              <input
                ...
                class="p-2 text-sm w-full rounded-lg"
              />
            </div>
            <button class="bg-red-500 hover:bg-red-600 px-5 py-2 text-sm text-white uppercase rounded-lg">
              Apply
            </button>
            <div class="border-t mt-8">
              ...
              <button class="bg-indigo-500 font-semibold rounded-lg hover:bg-indigo-600 py-3 text-sm text-white uppercase w-full">
                Checkout
              </button>
            </div>
          </div>
